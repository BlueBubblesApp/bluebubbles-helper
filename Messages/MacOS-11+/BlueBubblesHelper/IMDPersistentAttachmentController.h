...
- (NSString*)_persistentPathForTransfer:(IMFileTransfer*)arg1 filename:(NSString*)arg2 highQuality:(BOOL)arg3 chatGUID:(NSString* _Nullable)arg4 storeAtExternalPath:(BOOL)arg5 API_AVAILABLE(macos(10.16), ios(14.0), watchos(7.0));
...
- (void)moveAttachmentsForTransfer:(id)arg1 completion:(id)arg2;
- (void)saveAttachmentsForTransfer:(id)arg1 completion:(id)arg2;
